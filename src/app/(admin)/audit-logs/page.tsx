...
import { AuditLogFilterClient } from "@/app/(admin)/audit-logs/filter-client";
    ...
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-accent-foreground/60">
          View system activity logs for security and compliance monitoring.
          Track user actions, system events, and resource modifications.
        </p>
      </div>
      ...
      <div className="bg-card rounded-sm shadow-md">
        <div className="p-6">
          ...
          >
            <AuditLogTable auditLogs={auditLogs} pagination={pagination} />
          </AuditLogFilterClient>
        </div>
      </div>
    </div>
